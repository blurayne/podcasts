...
## V1 ✅ „Frauen verdienen für gleiche Arbeit 21 % weniger." *(Plakat-/Talkshow-Formel, links kommuniziert)*

- **Beweislage:** Der unbereinigte GPG vergleicht Durchschnitts-Stundenlöhne *aller*
  Beschäftigten — er misst ausdrücklich nicht „gleiche Arbeit" (Destatis-Definition).
  Aktueller Wert: **16 %** (2024 und 2025), nicht 21 %. Bei vergleichbarer Tätigkeit,
  Qualifikation und Erwerbsbiografie: **6 %** — von Destatis als Obergrenze deklariert.
- **Verdikt: IRREFÜHREND** (in der Zahl zusätzlich VERALTET)
- **Konfidenz:** hoch
- **Beste Gegenposition:** Die Formel zielt eigentlich auf „gleichWERTIGE Arbeit"
  (Entgeltgleichheits-Norm) und auf die Gesamtungleichheit der Erwerbsverläufe — als
  Beschreibung der Messgröße bleibt sie trotzdem falsch etikettiert.

## V2 ✅ „Der Gender Pay Gap beträgt 21 %." *(als aktuelle Zahl)*

- **Beweislage:** 2025: 16 % unbereinigt (22,81 € vs. 27,05 €/h). 21 % war der Stand
  von ca. 2017–2019 alter Methodik.
- **Verdikt: FALSCH** (als aktuelle Zahl); als historische Zahl BELEGT
- **Konfidenz:** hoch
- **Gegenposition:** Kampagnen-Vorlauf: Equal-Pay-Day-Materialien entstehen vor der
  jeweils neuesten PM — erklärt die Trägheit, heilt sie nicht.

## V3 ✅ „Die bereinigten 6 % sind der bewiesene Diskriminierungsanteil — 6 % weniger, einfach nur weil sie weiblich sind." *(linke Lesart, u. a. Referenzvideo 2)*

- **Beweislage:** Destatis deklariert den bereinigten Gap ausdrücklich als
  **Obergrenze** für Verdienstdiskriminierung (fehlende Erwerbsunterbrechungs- und
  Erfahrungsdaten → realer Wert vermutlich darunter). Er ist ein unerklärtes
  Residuum, keine Diskriminierungsmessung.
- **Verdikt: IRREFÜHREND**
- **Konfidenz:** hoch
- **Beste Gegenposition:** Der Fehler hat eine Spiegelung — s. V4: das Residuum ist
