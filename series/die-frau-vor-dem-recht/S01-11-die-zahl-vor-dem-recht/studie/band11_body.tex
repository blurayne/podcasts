...
ein zentraler Treiber der Gesamtl\"ucke. \belegt\ Ob er \emph{der} Haupttreiber
ist, l\"asst sich mit der vorliegenden Datenlage nicht abschlie\ss end
entscheiden. \vunent
...
\textbf{St\"arkste Gegenbelege:} Audit-Evidenz zu M\"utter-Nachteilen vor dem
Lohnzettel \plausibel; Devaluation frauentypischer Berufe \umstritten;
Bereinigungs-Blindstelle (wegkontrollierte Diskriminierung) \plausibel; der
gr\"o\ss ere \emph{bereinigte} Ost-Rest mahnt, den Rest nicht automatisch als
Funktionspreis zu lesen.

\begin{merksatz}
Verdikt: \vteil\ --- Der Mechanismus (Funktionspreis) ist gut belegt und
erkl\"art den Gro\ss teil der L\"ucke; die Restfrage (Diskriminierung vs.\
Unvermessenes) ist mit heutiger Datenlage \vunent. Und der Preis ist kein
...
\begin{itemize}
\item Bonaccolto-T\"opfer, Castagnetti et al.\ (2023): RIF-Dekomposition des deutschen Gender Pay Gap, Journal for Labour Market Research 57(11) --- Methodik und Grenzen der Bereinigung (deskriptiv; Selektionsverzerrung). \plausibel
