# Werkstattfolge II — „Der Gegenanwalt" (Arbeitstitel)
...
und Funktion — aber fundiert.** Die Folge übernimmt keine Anwaltschaft, weder die woke noch
die anti-woke. Sie prüft beide mit demselben Instrument (Axiom 4: Symmetrie der Methode).

---

## 1. Anlass und Fallstudie

Fallstudie ist der Psychologe **Varnan Chandreswaran** (varnan.de, YouTube @varnan.psycho,
Buch „Gefangen in der Opferrolle", Eulogia 2024; GWUP-Referent). Er ist der interessanteste
Vertreter des Gegenpols, weil er *kein* Polemiker ist: echte, peer-reviewte Studienbasis,
meist korrekt referiert, und ein dokumentiertes öffentliches Eingeständnis einer eigenen
Fehlprognose („Ich lag tatsächlich falsch" — seine eigene Erhebung fand *keinen* negativen
Zusammenhang zwischen Wokeness und psychischer Gesundheit; GWUP-Blog, Mai 2026).
Genau deshalb taugt er als Prüfstein: Wenn die Funktionskritik ihren Methodenkanon ernst
meint, muss sie am stärksten Gegenanwalt zeigen, wo Anwaltschaft anfängt — auf beiden Seiten.

## 2. Seine Studienbasis (varnan.de/thesen, Stand ~März 2025) — mit Einordnung

Rekonstruiert über Suchindex-Snippets (Direktzugriff auf die Seite war zum Recherchezeitpunkt
netzwerkseitig nicht möglich); Identifikation der Vollzitate teils zugeordnet.

| Zitat | Studie | Sein Punkt | Einordnung |
|---|---|---|---|
| Kessler 2017 | WHO World Mental Health Surveys, Eur. J. Psychotraumatology | ~70 % Lebenszeit-Traumaexposition | `[belegt]` |
| Walter 2020 | Walter/Conroy-Beam/Buss et al., Psych. Science (45 Länder, N=14.399) | Statuspräferenz bei Partnerwahl | `[belegt]` — von der Reihe selbst zitiert (Band VII) |
| Schaerer et al. 2023 | OBHDP 179, Meta-Analyse, 361.645 fiktive Bewerbungen | „seit 2009 keine Diskriminierung von Frauen, eher von Männern" | Kernbefund `[belegt]`; Verallgemeinerung `[umstritten]` — **Galos & Coppock 2023** (Science Advances): der Netto-Null-Befund ist Aggregationsartefakt, −3 pp gegen Frauen in männerdominierten (besser bezahlten) Berufen, +5 pp in frauendominierten; nur Callback-Ebene |
| Lahtinen 2024 | Scand. J. Psychology, CSJAS-Skala, n≈5.900 (Finnland) | Wokeness ↔ Angst/Depression | Korrelation `[belegt]`, aber schwach (r meist < 0,3), Querschnitt; nicht stärker als bloße linke Orientierung; Kausalrichtung `[spekulativ]` |
| Ok et al. 2021 | JPSP: virtuous victim signaling | Opfersignaling ↔ Dark Triad | `[belegt]` — misst Signalverhalten, nicht politisches Lager |
| Krispenz & Bertrams 2024 | Current Psychology: LWA & dunkle Traits | Linksautoritarismus ↔ Narzissmus | **`[umstritten]` — siehe § 3 (Cook et al. 2026)** |
| Moss & O'Connor 2020 | Heliyon | PC-Autoritarismus ↔ Dark Triad | `[belegt]` — findet dasselbe für Alt-Right; kein Links-Befund |
| Grubbs et al. 2019 | PLoS ONE: moral grandstanding | Moralisieren als Statussuche | `[belegt]` — ideologieübergreifend |
| Armaly (& Enders) 2022 | Political Behavior: perceived victimhood | Mediennarrative → Opfer-Selbstbild | Korrelationsbefund `[belegt]`, Kausalkette Medien→Opfermentalität `[spekulativ]` |
| Leppin 2014 / Joyce 2018 / Pinto 2021 / Llistosella 2023 | vier Resilienz-Meta-Analysen | Resilienztrainings wirken | `[belegt, kleine Effekte]` — nach Bias-Korrektur (White/Uttl/Holder 2019, PLOS ONE) eher r ≈ 0,1 |

Haltbarkeit seiner Großthesen: „bereinigter Pay Gap klein" `[belegt]`, „also keine strukturelle
Benachteiligung" `[umstritten]` (Blau & Kahn 2017 und Destatis machen den Sprung ausdrücklich
nicht mit; Child Penalty ~20 %, Kleven et al. 2019). „Kein Patriarchat" `[umstritten]` —
Ebenenwechsel von Callback-Daten auf Gesamtstruktur (Führungsanteile, Care Gap 44 %,
Partnerschaftsgewalt, Reversibilität). Muster insgesamt: echte Studien, einseitige Selektion,
Kausalsprünge, Ebenenwechsel — **Anwaltschaft, keine Gutachtertätigkeit.**

## 3. Das Herzstück: Krispenz & Bertrams 2024 vs. Cook et al. 2026

**Cook, A. (Sasha), Meyer, B. & Asbrock, F. (2026): „The whole picture: looking, again, at
left-wing authoritarianism and its associations with dark personality traits", Current
Psychology 45:1193, DOI 10.1007/s12144-026-09655-9** (Open Access; Daten/R-Skript: osf.io/7ktp3).

Reanalyse der Originaldaten von Krispenz & Bertrams 2024 (Study 2, N = 375, US-Sample) mit
Strukturgleichungsmodell (SAM) statt einfacher Regressionen — alle Dark-Triad-Dimensionen
simultan modelliert:

- **Narzissmus ↔ LWA: negativ** (β = −0,20) — das Vorzeichen dreht sich um.
- Die kleine positive Gesamtassoziation (β = 0,13) wird **allein von Psychopathie** getragen
  (β = 0,32; nur auf zwei LWA-Facetten; geringe Psychopathie-Varianz im Sample, teils
  zirkuläre Items — „never gotten into trouble with the law" misst bei Aktivisten Protest).
- **Social-Justice-Commitment konsistent positiv mit LWA** — widerspricht K&Bs Deutung, linke
  Aktivisten bedienten „ego-focused, sometimes even antisocial needs" statt Gerechtigkeit.
- Der K&B-Narzissmus-Befund: laut Cook et al. ein **methodisches Artefakt**.
- Stehen bleibt: Virtue Signaling ↔ Top-down-Zensur — anschlussfähig an Ok 2021/Grubbs 2019.
  Der belastbare Kern lautet „Moralisieren als Statusverhalten", nicht „linke Überzeugung als
  dunkles Persönlichkeitsmerkmal".

### Der Gegenpol-Twist: Auch die Reanalyse ist keine neutrale Instanz

Die Folge nutzt Cook et al. 2026 ausdrücklich **doppelt** — als Widerlegung *und* als Exempel
dafür, dass es im politisierten Feld keine Gutachterbank gratis gibt:

- Die Autoren kommen aus einer sozialpsychologischen Tradition, die primär
  **Rechtsautoritarismus und Vorurteile** erforscht. Ein symmetrischer Test — hätten sie mit
  gleichem Aufwand eine Studie reanalysiert, die rechte Gruppen pathologisiert *entlastet*? —
  fällt vermutlich negativ aus. `[Interpretation, nicht belegbar]`
- **Zur Fairness:** Das spiegelbildliche Framing-Problem hat das Original mindestens genauso —
  K&Bs „ego-focused, sometimes even antisocial needs"-Rhetorik plus die mediale Verwertung
  (PsyPost, Grokipedia, YouTube-Anti-Woke-Ökosystem).
- **Aber:** Offene Daten, offenes Skript (OSF) und die transparente Berichterstattung
  gegenläufiger Befunde (Psychopathie-Assoziation wird nicht versteckt) **neutralisieren den
  Bias-Verdacht auf der Analyseebene weitgehend.** Wer die Rechnung anzweifelt, kann sie
  nachrechnen — das ist der Unterschied zwischen Framing-Bias und Datenbias.
- Fazit für die Folge: Das Feld ist politisiert; **dieses Paper ist ein Zug in einem
  adversarialen Schlagabtausch, keine neutrale Instanz.** Genau deshalb braucht es die
...
- **Akt III — Dieselben Daten, anderes Modell:** Der Cook-Moment. K&B 2024 wird aufgerufen,
  die Reanalyse vorgelegt: umgekehrtes Vorzeichen, Social-Justice-Commitment echt. Dann der
  Twist aus § 3: Die Erzählerin dreht die Prüfung sofort gegen die Reanalyse selbst
  (Traditionslinie, vermutlich asymmetrische Auswahl des Reanalyse-Ziels `[Interpretation]`) —
  und rettet sie auf der Analyseebene (offene Daten, offenes Skript). Lehrsatz: **Im
  adversarialen Feld ersetzt Transparenz das Vertrauen in Personen.**
- **Akt IV — Die Opferstatus-Frage:** Was vom Gegenanwalt bleibt, gehört der Funktionskritik:
...
- Keine Häme in beide Richtungen; Schuldrhetorik-Verbot gilt auch gegenüber „woke" und
  „anti-woke". Kritisiert werden Auslassung, Kausalsprung und Ebenenwechsel — nicht Personen.
...
- Einordnung als S01-11 oder als „Werkstatt II" außerhalb der Zählung (analog „Koda").
- Studien-PDF-Ablage: Cook et al. 2026 ist CC BY 4.0 — darf mit Attribution in `studie/`
  abgelegt werden; übrige Paper nur verlinken (Copyright).
